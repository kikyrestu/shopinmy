    ...
    @else
        <form wire:submit.prevent="subscribe" class="relative group mt-4">
            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <i class="ph ph-envelope-simple text-xl text-gray-400 dark:text-gray-600 group-focus-within:text-brand-500 transition-colors"></i>
            </div>
            <input type="email" wire:model="email" required
                class="block w-full pl-12 pr-32 py-3.5 bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl text-sm placeholder-gray-400 focus:bg-white dark:bg-gray-900 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition-all outline-none" 
