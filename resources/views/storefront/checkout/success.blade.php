...
@section('content')
<div class="bg-gray-50 dark:bg-[#121212] py-20 min-h-[60vh] flex items-center justify-center">
    <div class="max-w-4xl w-full mx-auto px-4 sm:px-6">
        <div class="bg-white dark:bg-gray-900 rounded-3xl p-8 sm:p-12 text-center shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mt-12">
                ...
                @auth
                <a href="{{ route('dashboard') }}" class="px-8 py-3.5 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 hover:border-gray-300 text-gray-700 dark:text-gray-300 font-bold rounded-full transition-all">
