<div class="contents">
    ...
    @else
        <a href="{{ route('cart.index') }}" class="p-2 text-gray-500 dark:text-gray-500 hover:text-brand-600 hover:bg-brand-50 rounded-full transition-all relative group inline-block">
