        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex text-sm text-gray-500 dark:text-gray-500 font-medium">
                <ol class="flex items-center space-x-2">
                    ...
                    <li class="text-gray-900 dark:text-gray-100">{{ __('Checkout') }}</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="flex-1 space-y-2 md:space-y-8">
                ...
                <div class="bg-white dark:bg-gray-900 md:rounded-3xl border-y md:border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('Full Name') }}</label>
                            <input type="text" wire:model="name" required class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:bg-white dark:bg-gray-900 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                            @error('name') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('Phone Number') }}</label>
                            <input type="text" wire:model="phone" required class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:bg-white dark:bg-gray-900 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                            @error('phone') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                        </div>
                        <div class="sm:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('Email Address') }}</label>
                            <input type="email" wire:model="email" required class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:bg-white dark:bg-gray-900 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($userAddresses as $addr)
                                <label class="block relative cursor-pointer group">
                                    ...
                                    <div class="h-full bg-white dark:bg-gray-900 rounded-2xl border-2 {{ $selectedAddressId == $addr->id ? 'border-brand-500 ring-4 ring-brand-50' : 'border-gray-100 dark:border-gray-800 group-hover:border-gray-200 dark:border-gray-700' }} shadow-sm p-5 transition-all">
                                        @if($addr->is_default)
                                        ...
                                        <div class="flex items-center gap-3 mb-3">
                                            ...
                                            <div class="font-bold text-gray-900 dark:text-gray-100">{{ $addr->label ?? __('Address') }}</div>
                                        </div>
                    ...
                    @else
                        ...
                        @if(count($userAddresses) > 0)
                            <div class="mb-4 flex justify-end">
                                <button wire:click="$set('showNewAddressForm', false)" class="text-sm font-semibold text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 flex items-center gap-1">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" wire:model="address_line" required class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:bg-white dark:bg-gray-900 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.live.debounce.500ms="postcode" required class="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 text-sm focus:bg-white dark:bg-gray-900 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                ...
                <div class="bg-white dark:bg-gray-900 md:rounded-3xl border-y md:border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-8">
                    ...
                    @if($isCalculatingShipping)
                        <div class="flex items-center gap-3 text-gray-500 dark:text-gray-500 py-4">
                    ...
                    @else
                        <div class="space-y-3">
                            @foreach($availableCouriers as $code => $rate)
                                <label class="flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all {{ $courier === $code ? 'border-brand-500 bg-brand-50/50' : 'border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:border-gray-700' }}">
                                    <div class="flex items-center gap-3">
                                        <input type="radio" name="courier" wire:model.live="courier" value="{{ $code }}" class="w-5 h-5 text-brand-600 focus:ring-brand-500">
                                        <span class="font-bold text-gray-900 dark:text-gray-100">{{ $rate['name'] }}</span>
                                    </div>
                ...
                <div class="bg-white dark:bg-gray-900 md:rounded-3xl border-y md:border border-gray-100 dark:border-gray-800 shadow-sm p-4 sm:p-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all {{ $payment_method === 'billplz' ? 'border-brand-500 bg-brand-50/50' : 'border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:border-gray-700' }}">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">FPX Online Banking (Billplz)</span>
                            </div>
                        ...
                        <label class="flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all {{ $payment_method === 'stripe' ? 'border-brand-500 bg-brand-50/50' : 'border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:border-gray-700' }}">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">Credit / Debit Card (Stripe)</span>
                            </div>
                            <div class="flex gap-1 text-gray-400 dark:text-gray-600">
                        ...
                        <label class="flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all {{ $payment_method === 'manual_transfer' ? 'border-brand-500 bg-brand-50/50' : 'border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:border-gray-700' }}">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">Manual Bank Transfer</span>
                            </div>
                        </label>
                        @endif
                        ...
                        <label class="flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all {{ $payment_method === 'cod' ? 'border-brand-500 bg-brand-50/50' : 'border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:border-gray-700' }}">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-bold text-gray-900 dark:text-gray-100">Cash on Delivery</span>
                            </div>
            ...
            <div class="w-full lg:w-[400px] xl:w-[450px]">
                <div class="bg-white dark:bg-[#18181B] md:rounded-3xl md:border border-gray-100 dark:border-gray-800 md:shadow-sm p-4 md:p-8 md:sticky md:top-28">
                    ...
                    <ul class="space-y-4 mb-6">
                        ...
                        <li class="flex gap-4">
                            <div class="w-16 h-16 bg-gray-50 dark:bg-[#121212] rounded-xl overflow-hidden flex-shrink-0 border border-gray-100 dark:border-gray-800 relative">
                            ...
                            <div class="flex-1 text-sm">
                                <div class="font-bold text-gray-900 dark:text-gray-100 line-clamp-2">{{ $item->product->name }}</div>
                                @if($item->variant)
                                    <div class="text-gray-500 dark:text-gray-500 mt-0.5">{{ $item->variant->value }}</div>
                                @endif
                            </div>
                            @php
                                $price = $item->effective_price;
                            @endphp
                            <div class="font-bold text-gray-900 dark:text-gray-100">RM {{ number_format($price * $item->qty, 2) }}</div>
                        </li>
                        @endforeach
                    </ul>

                    <hr class="border-gray-100 dark:border-gray-800 mb-6 mt-6">

                    <!-- Bug-U02: Voucher Section -->
                    <div class="mb-6">
                        <div class="flex gap-2">
                            <input type="text" wire:model.defer="voucherCode" placeholder="{{ __('Enter Voucher Code') }}" class="flex-1 w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all uppercase">
                    ...
                    <div class="space-y-3 text-sm mb-6">
                        ...
                        <div class="flex justify-between items-center text-gray-600 dark:text-gray-400 font-medium">
                            ...
                            <span class="text-gray-900 dark:text-gray-100 font-bold">RM {{ number_format($shippingCost, 2) }}</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center text-gray-600 dark:text-gray-400 font-medium">
                            ...
                            <span class="text-gray-900 dark:text-gray-100 font-bold">RM {{ number_format($taxAmount, 2) }}</span>
                        </div>
                        @endif

                        <div class="flex justify-between items-end pt-4 border-t border-gray-100 dark:border-gray-800 mt-2">
                            <span class="text-base font-bold text-gray-900 dark:text-gray-100">{{ __('Total') }}</span>
                    ...
                    <p class="text-center text-xs text-gray-400 dark:text-gray-600 mt-4 px-2">
